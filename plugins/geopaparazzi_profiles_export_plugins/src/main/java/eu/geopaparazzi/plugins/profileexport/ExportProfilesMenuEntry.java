...
import eu.geopaparazzi.library.webprofile.WebProfilesUploadListActivity;

/**
 * @author Andrea Antonello (www.hydrologis.com)
 */
public class ExportProfilesMenuEntry extends MenuEntry {

    private final Context serviceContext;

    public ExportProfilesMenuEntry(Context context) {
    ...
    public void onClick(IActivitySupporter clickActivityStarter) {
        ...
        Intent webExportIntent = new Intent(context, WebProfilesUploadListActivity.class);
        webExportIntent.putExtra(LibraryConstants.PREFS_KEY_PROFILE_URL, server);
        webExportIntent.putExtra(LibraryConstants.PREFS_KEY_USER, user);
        webExportIntent.putExtra(LibraryConstants.PREFS_KEY_PWD, passwd);
        clickActivityStarter.startActivity(webExportIntent);
    }
