...
public class MBTilesTileCache implements ITileCache {

    static final org.slf4j.Logger log = LoggerFactory.getLogger(MBTilesTileCache.class);
    ...
    public MBTilesTileCache(Context context, String dbPath) {
        if (dbg)
            log.debug("open mbtiles {}", dbPath);

        dbHelper = new SQLiteHelper(context, dbPath);
