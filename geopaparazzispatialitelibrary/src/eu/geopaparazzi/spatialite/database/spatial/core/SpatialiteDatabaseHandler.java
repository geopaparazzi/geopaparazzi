                    ...
                    if ((!s_table_name.equals("")) && (s_data_type.equals("tiles"))) {
                        ...
                        try {
                            if (this_stmt.step()) {
                             ...
                             GPLog.androidLog(4, "SpatialiteDatabaseHandler.get_tables_gpkg [tiles - min/max zoom] prepair[" + s_sql_layers + "]", e);
                            }
                        finally {
                            if (this_stmt != null) {
                                this_stmt.close();
                    ...
                    if (!s_table_name.equals("")) {
                        ...
                        if (!s_sql_layers.equals("")) {
                            ...
                            try {
                             ...
                             GPLog.androidLog(4, "SpatialiteDatabaseHandler.get_tables_gpkg [bounds] prepair[" + s_sql_layers + "]", e);
                            } finally {
                                if (this_stmt != null) {
                                    this_stmt.close();
                                }
                ...
                while( this_stmt.step() ) {
                    ...
                    if ((!table_name.equals("")) && (!geometry_column.equals("")) && (i_test > 0)) { // checking
                        ...
                        try {
                         ...
                         GPLog.androidLog(4, "SpatialiteDatabaseHandler.get_tables_spatialite prepair[" + s_CheckSpatialIndex + "]", e);
                        } finally {
                            if (bounds_stmt != null) {
                                bounds_stmt.close();
                            }
                    ...
                    if (i_database_type == 3) { // for older spatialite v2+3 : Query extent of table
                        ...
                        try {
                         ...
                         GPLog.androidLog(4, "SpatialiteDatabaseHandler.get_tables_spatialite prepair[" + s_select_bounds + "]", e);
                        } finally {
                            if (bounds_stmt != null) {
                                bounds_stmt.close();
                            }
