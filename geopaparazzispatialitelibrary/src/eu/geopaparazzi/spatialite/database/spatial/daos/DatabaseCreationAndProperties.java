...
package eu.geopaparazzi.spatialite.database.spatial.daos;
...
import eu.geopaparazzi.spatialite.util.SpatialiteVersion;
...
public class DatabaseCreationAndProperties implements ISpatialiteTableAndFieldsNames {
     ...
     * @return the {@link eu.geopaparazzi.spatialite.util.SpatialiteVersion}.
     * @throws Exception if something goes wrong.
     */
