...
public class SensorSelectorFragment extends ListFragment {
    ...
    public void setSensorDisplay( SensorDisplayFragment sensorDisplay ) {
        ...
        this.setListAdapter(new SensorListAdapter(getActivity().getApplicationContext(), android.R.layout.simple_list_item_1,
                sensors));
    }
        ...
        public View getView( final int position, View convertView, ViewGroup parent ) {
            ...
            convertView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick( View v ) {
                    if (Debug.D) {
                        Log.d(TAG, "display sensor! " + selectedSensor.getName());
                    }
