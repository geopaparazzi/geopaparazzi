 ...
 */
package eu.geopaparazzi.library.sensors.news;
...
public class SensorDisplayFragment extends Fragment implements SensorEventListener {
    ...
    public void onSensorChanged( SensorEvent event ) {
        ...
        case Sensor.TYPE_ACCELEROMETER:
            showEventData("Acceleration - gravity on axis", ACCELERATION_UNITS, event.values[0], event.values[1], event.values[2]);
            break;
        ...
        case Sensor.TYPE_GYROSCOPE:
            showEventData("Angular speed around axis", "radians/sec", event.values[0], event.values[1], event.values[2]);
            break;
        ...
        case Sensor.TYPE_LINEAR_ACCELERATION:
            showEventData("Acceleration (not including gravity)", ACCELERATION_UNITS, event.values[0], event.values[1],
                    event.values[2]);
            break;
