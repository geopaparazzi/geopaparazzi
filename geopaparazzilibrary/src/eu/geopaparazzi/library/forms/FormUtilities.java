...
public class FormUtilities {
    ...
    public static View addSketchView( final Context context, LinearLayout mainView, String key, String value,
        ...
        //
        // final EditText imagesText = new EditText(context);
        // imagesText.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
        // LayoutParams.WRAP_CONTENT));
        // imagesText.setPadding(2, 2, 2, 2);
        // imagesText.setText(value);
        // imagesText.setTextColor(context.getResources().getColor(R.color.black));
        // imagesText.setKeyListener(null);
        // textLayout.addView(imagesText);
        // ViewTreeObserver observer = imagesText.getViewTreeObserver();
        // observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(){
        // public void onGlobalLayout() {
        // Logger.i("FORMUTILITIES", "On global View triggered");
        // }
        // });
        // observer.addOnGlobalFocusChangeListener(new
        // ViewTreeObserver.OnGlobalFocusChangeListener(){
        // public void onGlobalFocusChanged( View oldFocus, View newFocus ) {
        // Logger.i("FORMUTILITIES", "On global focus triggered");
        // if (newFocus.getId() == imagesText.getId()) {
        // Logger.i("FORMUTILITIES", "On global focus triggered: coming back to");
        // }
        // }
        // });
        // observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener(){
        // public boolean onPreDraw() {
        // Logger.i("FORMUTILITIES", "On preDraw triggered");
        // return true;
        // }
        // });
        //
        ...
        // if (imagesText.getText().toString().length() > 0) {
        // ScrollView scrollView = new ScrollView(context);
        // ScrollView.LayoutParams scrollLayoutParams = new
        // ScrollView.LayoutParams(LayoutParams.FILL_PARENT,
        // LayoutParams.WRAP_CONTENT);
        // scrollView.setLayoutParams(scrollLayoutParams);
        // mainView.addView(scrollView);
        //
