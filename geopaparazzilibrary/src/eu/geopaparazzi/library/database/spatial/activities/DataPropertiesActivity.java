...
// */
//public class DataPropertiesActivity extends Activity {
...
//                    Intent intent = new Intent(DataPropertiesActivity.this, ChartActivity.class);
...
//                public void onClick( View v ) {
//                    try {
//                        double[] firstPoint = DaoGpsLog.getGpslogFirstPoint(DataPropertiesActivity.this, item.getId());
//                        if (firstPoint != null) {
...
//                    try {
//                        long id = item.getId();
//                        new DaoGpsLog().deleteGpslog(DataPropertiesActivity.this, id);
//                        finish();
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
...
//                public void onClick( View v ) {
//                    try {
//                        DaoGpsLog.updateLogProperties(DataPropertiesActivity.this, item.getId(), newColor, newWidth,
