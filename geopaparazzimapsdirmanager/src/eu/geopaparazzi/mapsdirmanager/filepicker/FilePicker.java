 ...
 */
package eu.geopaparazzi.mapsdirmanager.filepicker;
...
import eu.geopaparazzi.mapsdirmanager.R;
import eu.geopaparazzi.mapsdirmanager.filefilter.ValidFileFilter;
 ...
 * selected_nodes file is valid before its path is returned. By default all files are considered as valid and can be selected_nodes.
 */
public class FilePicker extends Activity implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                File selected_nodesFile = this.files[(int) id];
                if (selected_nodesFile.isDirectory()) {
                        this.currentDirectory = selected_nodesFile;
                        browseToCurrentDirectory();
                } else if (fileSelectFilter == null || fileSelectFilter.accept(selected_nodesFile)) {
                   Intent send_intent=new Intent();
                   s_file_name=selected_nodesFile.getAbsolutePath();
