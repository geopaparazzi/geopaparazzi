...
public class CustomTileTable {
    ...
    public CustomTileTable( String s_map_file, String s_name, String srid, int minZoom, int maxZoom, double centerX,
            double centerY, String tileQuery, double[] bounds,CustomTileDownloader customTileDownloader ) {
        ...
        if (this.customTileDownloader != null)
        { // avoid crash, but loading the map will fail
         setDescription(customTileDownloader.getDescription());
        }
        // todo: change this
        if (tileQuery != null) {
       ...
       //  GPLog.androidLog(-1,"CustomTileTable[" + file_map.getAbsolutePath() + "] name["+s_name+"] s_description["+s_description+"]");
    }
