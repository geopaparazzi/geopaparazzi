...
public class OsmActivity extends Activity {
    ...
    public void onCreate( Bundle icicle ) {
        ...
        buttonsLayout.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
                LayoutParams.FILL_PARENT));
        ...
        transparentPanel.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
        ...
        android.widget.RelativeLayout.LayoutParams paramsOut = new RelativeLayout.LayoutParams(
        ...
        android.widget.RelativeLayout.LayoutParams paramsIn = new RelativeLayout.LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public boolean onCreateOptionsMenu( Menu menu ) {
        ...
        menu.add(Menu.NONE, MENU_GPSDATA, 1, R.string.mainmenu_gpsdataselect).setIcon(
                R.drawable.ic_menu_compass);
        menu.add(Menu.NONE, MENU_MAPDATA, 2, R.string.mainmenu_mapdataselect).setIcon(
                R.drawable.ic_menu_compass);
        menu.add(Menu.NONE, MENU_ADDTAGS, 3, R.string.mainmenu_addtags).setIcon(
                R.drawable.ic_menu_add);
        menu.add(Menu.NONE, CENTER_ON_GPS, 4, R.string.centerongps).setIcon(
                R.drawable.menu_mylocation);
        menu.add(Menu.NONE, MENU_TOGGLE_MEASURE, 5, R.string.mainmenu_togglemeasure).setIcon(
                R.drawable.ic_menu_measure);
        menu.add(Menu.NONE, MENU_REMOVE_LAST_NOTE, 6, R.string.mainmenu_removelastnote).setIcon(
                R.drawable.ic_menu_remove);
        menu.add(Menu.NONE, MENU_GPXCONVERT, 7, R.string.mainmenu_gpxconvert).setIcon(
                R.drawable.gpxconvert);
