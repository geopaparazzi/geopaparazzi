...
public class ActionBar {
	...
	public void startAnimation(int buttonId, int animationId) {
		View button = actionBarView.findViewById(buttonId);
		if (button != null) {
			Animation buttonAnimation = AnimationUtils.loadAnimation(
					button.getContext(), animationId);
	...
	public void setTitleWithCustomFont(int titleResourceId, int titleViewId,
			String assetFontFile) {
