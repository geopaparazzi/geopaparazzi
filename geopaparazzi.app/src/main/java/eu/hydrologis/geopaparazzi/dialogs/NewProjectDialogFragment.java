...
public class NewProjectDialogFragment extends DialogFragment {
    ...
    private ApplicationChangeListener appChangeListener;
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof ApplicationChangeListener) {
            appChangeListener = (ApplicationChangeListener) activity;
        }
    }
