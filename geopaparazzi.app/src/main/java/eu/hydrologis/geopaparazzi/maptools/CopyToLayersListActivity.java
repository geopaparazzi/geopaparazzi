    ...
    public void onCreate(Bundle icicle) {
        ...
        try {
            ...
            if (compatibleSpatialVectorTables.size() == 0) {
                GPDialogs.warningDialog(this, getString(eu.hydrologis.geopaparazzi.R.string.no_compatible_layers_found), new Runnable() {
                    @Override
                    public void run() {
                        finish();
                    }
                    ...
                    try {
                        ...
                        editableButton.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                ...
                                if (count > 0)
                                    GPDialogs.toast(editableButton.getContext(), String.format(getString(eu.hydrologis.geopaparazzi.R.string.copied_features_to_layer), count, spatialVectorTable.getTableName()), Toast.LENGTH_SHORT);
