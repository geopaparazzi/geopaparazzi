 ...
 *
 * <pre>
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_collapsible
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_src_expanded
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_src_collapsed
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_indent_width
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_handle_trackball_press
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_indicator_gravity
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_indicator_background
 * attr ref eu.geopaparazzi.mapsforge.mapsdirmanager.R.styleable#TreeViewList_row_background
 * </pre>
 */
...
public class TreeViewList extends ListView {
    ...
    public TreeViewList(final Context context, final AttributeSet attrs) {
        this(context, attrs, R.style.mapsdir_treeview_ListStyle);
    }
