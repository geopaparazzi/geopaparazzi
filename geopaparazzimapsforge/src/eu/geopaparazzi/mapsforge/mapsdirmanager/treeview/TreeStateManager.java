...
public interface TreeStateManager<T> extends Serializable {
     ...
     */
    void addBeforeChild(T parent, T newChild, T beforeChild,TreeNode this_classinfo);
     ...
     */
    void addAfterChild(T parent, T newChild, T afterChild,TreeNode this_classinfo);
