...
public class CloudProfileExportDialogFragment extends DialogFragment {
    ...
    public static CloudProfileExportDialogFragment newInstance(final String serverUrl, final String user, final String pwd) {
        CloudProfileExportDialogFragment f = new CloudProfileExportDialogFragment();
    ...
    private void startExport() {
        new AsyncTask<String, Void, String>() {
            protected String doInBackground(String... params) {
                try {
                    String message = WebProfileManager.INSTANCE.uploadProfile(getActivity(), serverUrl, user, pwd);
                    return message;
                } catch (Exception e) {
