 ...
 */
public class GeopackageLabelDialogFragment extends DialogFragment {
     ...
     * @return the instance.
     */
    public static GeopackageLabelDialogFragment newInstance(LabelObject labelObject) {
        GeopackageLabelDialogFragment f = new GeopackageLabelDialogFragment();
        ...
        builder.setPositiveButton(R.string.set_properties,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            ASpatialDb db = GeopackageConnectionsHandler.INSTANCE.getDb(mCurrentLabelObject.dbPath);
                            if (db instanceof GPGeopackageDb) {
                                GPGeopackageDb gpDb = (GPGeopackageDb) db;
                                BasicStyle style = gpDb.getBasicStyle(mCurrentLabelObject.tableName);
                                ...
                                gpDb.updateSimplifiedStyle(mCurrentLabelObject.tableName, style.toString());
                            }
                        } catch (Exception e) {
