...
public class LineCreateFeatureToolGroup implements ToolGroup, OnClickListener, OnTouchListener, View.OnLongClickListener {
     ...
     */
    public LineCreateFeatureToolGroup(GPMapView mapView, Feature featureToContinue) {
        ...
        if (this.featureToContinue != null) {
            ...
            try {
                lineGeometry = this.featureToContinue.getDefaultGeometry();
            ...
            if (coordinatesList.size() > 1) {
                ...
                try {
                    if (this.featureToContinue == null) {
                        ...
                        editLayer.updateFeatureGeometry(featureToContinue, lineGeometry, LibraryConstants.SRID_WGS84_4326);
                    }
