 ...
 */
public class AlphanumericOnSelectionToolGroup implements ToolGroup, OnClickListener, OnTouchListener, OnSelectionToolGroup {
     ...
     */
    public AlphanumericOnSelectionToolGroup(GPMapView mapView, List<Feature> selectedFeatures) {
    ...
    public void onClick(View v) {
        if (v == editAttributesButton) {
            ...
            if (isInDeletePreview) {
                ...
                EditManager.INSTANCE.setActiveToolGroup(new AlphanumericEditingToolGroup(mapView));
