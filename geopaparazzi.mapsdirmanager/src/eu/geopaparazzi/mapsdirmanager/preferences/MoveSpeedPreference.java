 ...
 */
package eu.geopaparazzi.mapsdirmanager.preferences;

import eu.geopaparazzi.mapsdirmanager.MapsDirActivity;
...
public class MoveSpeedPreference extends SeekBarPreference {
        ...
        public MoveSpeedPreference(Context context, AttributeSet attrs) {
                ...
                this.seekBarCurrentValue = this.preferencesDefault.getInt(this.getKey(), MapsDirActivity.MOVE_SPEED_DEFAULT);
                this.max = MapsDirActivity.MOVE_SPEED_MAX;
        }
